...
function compare( a, b ) {
    return a === b       // strick equality should be enough unless zero
      && a !== 0         // because 0 === -0, requires test by _compare()
      || _compare( a, b ) // handles not strictly equal or zero values
    ;
    ...
    function _compare( a, b ) {
      ...
      switch( s ) {
        ...
        case '[object Array]':
          ...
          while ( l-- ) {
            if ( ( x = a[ l ] ) === ( y = b[ l ] ) && x !== 0 || _compare( x, y ) ) continue;
            return false;
          }
          return true;
        // [object Array]
        ...
        case '[object Object]':
          ...
          for ( p in a ) {
            if ( a.hasOwnProperty( p ) ) {
              ++l;
              if ( ( x = a[ p ] ) === ( y = b[ p ] ) && x !== 0 || _compare( x, y ) ) continue;
              return false;
            }
          }
          return true;
